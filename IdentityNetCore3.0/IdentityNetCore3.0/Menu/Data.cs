...
namespace IdentityNetCore3.Menu
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 19, nameOption = "Boonsong1", imageClass = "fa fa-sitemap fa-fw", status = true, isParent = true, parentId = 0 });
            menu.Add(new Navbar { Id = 20, nameOption = "Boonsong2", imageClass = "fa fa-sitemap fa-fw", status = true, isParent = true, parentId = 0 });
